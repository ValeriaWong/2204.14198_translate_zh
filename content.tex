...
【qianshuhao翻译】首先在海量数据上进行预训练，然后在下游任务上进行微调的范式已成为标准 [引文：mikolov2010recurrent,graves2013generating,jozefowicz2016exploring,howard2018universal,bert,t5,sutskever2011generating,gpt3]。
